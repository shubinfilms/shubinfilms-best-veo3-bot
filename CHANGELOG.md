...
## Unreleased
- Централизован ранний ACK и дебаунс callback-кнопок, добавлены метрики `ui_callback_*`.
- Обработчик ошибок подавляет «Query is too old…», `safe_answer` защищает повторные клики.
