...
SUNO_RU = {
    ...
    "suno.prompt.step.title": "Шаг {index}/{total}: Укажите короткое название трека.",
    "suno.prompt.step.style": "Шаг {index}/{total}: Опишите стиль, теги или настроение.",
    "suno.prompt.step.lyrics": "Шаг {index}/{total}: Вставьте текст песни (можно несколько строк).",
    "suno.prompt.step.source": (
        f"Шаг {{index}}/{{total}}: Пришлите аудио-файл (mp3/wav, до {MAX_AUDIO_MB} МБ) или ссылку на аудио (http/https)."
    ),
