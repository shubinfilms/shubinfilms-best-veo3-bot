...
_register_label("🔄 Движок", "🔁 Сменить движок", "🔁 Switch engine", prefix=True)
...
_register_label("↩️ Назад", "↩️ Back")
...
_register_label("🚀 Начать генерацию", "🚀 Начать генерацию Banana", prefix=True)
_register_label("➕ Добавить фото", "➕ Добавить ещё фото")
_register_label("🧹 Очистить", "🧹 Очистить фото")
_register_label("✏️ Промпт", "✍️ Изменить промпт")
