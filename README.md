...
# 5. Когда генерация завершится, бот пришлёт альбом из четырёх фото (подпись у первого кадра с форматом и первыми 100 символами промпта) и кнопками «Открыть», «Повторить», «Назад в меню».
