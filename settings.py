...
SORA2_TIMEOUT = os.getenv("SORA2_TIMEOUT")
SORA2_TIMEOUT_CONNECT = os.getenv("SORA2_TIMEOUT_CONNECT")
SORA2_TIMEOUT_READ = os.getenv("SORA2_TIMEOUT_READ")
SORA2_TIMEOUT_WRITE = os.getenv("SORA2_TIMEOUT_WRITE")
SORA2_TIMEOUT_POOL = os.getenv("SORA2_TIMEOUT_POOL")
